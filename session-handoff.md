...
- The shorter `questfit.vercel.app` belongs to an unrelated project. The hosting project and permanent production alias use `questfit-adventure`; inherited Vercel SSO protection was disabled and anonymous HTTPS access now returns the QuestFit application.
