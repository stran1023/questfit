...
- 2026-07-21: Deployed the verified production build to the Git-connected Vercel project `questfit`; the public homepage, planning route, and workout-generation API passed live HTTP checks at `https://questfit-adventure.vercel.app`.
